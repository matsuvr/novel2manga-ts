...
--> statement-breakpoint
ALTER TABLE `jobs` ADD `user_id` text REFERENCES users(id);--> statement-breakpoint
CREATE INDEX `idx_jobs_user_id` ON `jobs` (`user_id`);--> statement-breakpoint
ALTER TABLE `novels` ADD `user_id` text REFERENCES users(id);--> statement-breakpoint
