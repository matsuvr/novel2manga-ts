...
import { EpisodeData, ChunkData } from "@/types/panel-layout";
  ...
  try {
    ...
    for (let i = episode.startChunk; i <= episode.endChunk; i++) {
      ...
      try {
        ...
        const endOffset = i === episode.endChunk ? episode.endCharIndex : chunkContent.content.length;
