...
import type { Episode, Job, NewEpisode, NewJob, NewNovel, NewOutput, Novel, Output } from "@/db/schema";
import { adaptAll, adaptEpisodePort, adaptJobPort, adaptNovelPort, adaptOutputPort } from "@/repositories/adapters";
...
class MockDatabaseService implements DatabaseService {
  ...
  // Novel methods
  async ensureNovel(id: string, data: Omit<NewNovel, "id" | "createdAt" | "updatedAt">): Promise<void> {
