...
JSONのみ。expandedText は改行を保持。文字数は target ±20% 以内。`,
  ...
  verticalText: { enabled: true, defaults: { fontSize: 24, lineHeight: 1.6, letterSpacing: 0, padding: 12, maxCharsPerLine: 14 }, maxConcurrent: 4, dynamicCoverage: { enabled: true, heightCoverage: 0.75, minCharsPerLine: 4 } },
      canvas: {
