import { LayoutTemplate } from "@/types/panel-layout";
...
export const layoutTemplates: LayoutTemplate[] = [
  {
    ...
    panelCount: 1,
    panels: [
      { position: { x: 0, y: 0 }, size: { width: 1.0, height: 1.0 }, priority: 1 }
    ]
  },
  {
  ...
  },
  {
    ...
    panels: [
      ...
      { position: { x: 0.0, y: 0.05 }, size: { width: 0.50, height: 0.48 }, priority: 2 },
  ...
  },
  {
    ...
    panelCount: 4,
    panels: [
      { position: { x: 0.50, y: 0.05 }, size: { width: 0.50, height: 0.55 }, priority: 1 },
      { position: { x: 0.0, y: 0.05 }, size: { width: 0.50, height: 0.20 }, priority: 2 },
      { position: { x: 0.0, y: 0.25 }, size: { width: 0.50, height: 0.35 }, priority: 3 },
      { position: { x: 0.0, y: 0.60 }, size: { width: 1.0, height: 0.40 }, priority: 4 }
    ]
  },
  {
    ...
    panels: [
      { position: { x: 0.52, y: 0.05 }, size: { width: 0.48, height: 0.25 }, priority: 1 },
      { position: { x: 0.0, y: 0.05 }, size: { width: 0.50, height: 0.48 }, priority: 2 },
      { position: { x: 0.0, y: 0.30 }, size: { width: 0.50, height: 0.23 }, priority: 3 },
      { position: { x: 0.0, y: 0.53 }, size: { width: 1.0, height: 0.20 }, priority: 4 },
  ...
  },
  {
    ...
    panels: [
      ...
      { position: { x: 0.0, y: 0.50 }, size: { width: 0.48, height: 0.18 }, priority: 3 },
      { position: { x: 0.53, y: 0.28 }, size: { width: 0.47, height: 0.27 }, priority: 4 },
      { position: { x: 0.35, y: 0.55 }, size: { width: 0.50, height: 0.18 }, priority: 5 },
  ...
  },
  {
    ...
    panelCount: 4,
    panels: [
      { position: { x: 0.0, y: 0.05 }, size: { width: 1.0, height: 0.40 }, priority: 1 },
      { position: { x: 0.58, y: 0.48 }, size: { width: 0.42, height: 0.17 }, priority: 2 },
      { position: { x: 0.0, y: 0.65 }, size: { width: 0.60, height: 0.35 }, priority: 3 },
      { position: { x: 0.60, y: 0.65 }, size: { width: 0.40, height: 0.35 }, priority: 4 }
    ]
  }
];
...
export function selectLayoutTemplate(
  ...
  const candidates = layoutTemplates.filter(t => 
    Math.abs(t.panelCount - panelCount) <= 1
  );
  
  // 均等分割を避ける
  const validCandidates = candidates.filter(template => 
